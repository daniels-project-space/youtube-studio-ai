...
assert.match(
  generatedFootage,
  /produces:\s*\[\s*"footageClips",\s*"footageKeys",\s*"generatedFootageSceneManifest",\s*"footageOnScreenTextCues",\s*"footageRenderer",\s*"h3VisualTreatmentId",\s*"h3VisualTreatmentSelection",\s*\]/,
  "generated footage must publish H3 renderer/treatment identity and deterministic-overlay OCR obligations separately from raw clips",
);
assert.match(
  generatedFootage,
