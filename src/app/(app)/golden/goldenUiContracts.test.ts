...
const salesPitches = readFileSync(`${here}/moduleSalesPitches.ts`, "utf8");
...
assert.match(page, /moduleSalesPitch\(m\)/);
assert.match(page, /className=\{styles\.modulePromise\}/);
assert.match(salesPitches, /Find a channel angle worth building/);
