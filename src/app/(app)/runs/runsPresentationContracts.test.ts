...
assert.match(detailPage, /failure\.recovery === "youtube_connection"/);
assert.match(detailPage, /href=\{`\/channels\/\$\{channelSlug\}\?tab=settings`\}/);
assert.match(detailStyles, /\.errorAction \{/);
