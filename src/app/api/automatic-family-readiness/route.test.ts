...
assert.match(source, /automaticFamilyCreatorReadiness\(family\)/, "the UI endpoint must verify the complete creator contract");
assert.doesNotMatch(source, /assessAutomaticFamilyExecutionReadiness/, "the Vercel UI process must not impersonate Trigger provider readiness");
