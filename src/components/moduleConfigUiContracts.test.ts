...
assert.match(section, /<details className=\{styles\.module\} open=\{open\}/u);
assert.match(section, /useState\(index === 0\)/u, "only the first active stage should open by default");
