...
assert.match(panel, /parsed\.pathname !== "\/api\/asset-image"/);
assert.match(panel, /searchParams\.set\("probe", "1"\)/);
assert.match(panel, /thumbnail preview unavailable/);
...
assert.match(panel, /data-thumbnail-candidate-rail/);
assert.match(panel, /Previous new thumbnails/);
assert.match(panel, /Next new thumbnails/);
assert.match(panel, /new ResizeObserver\(measure\)/);
assert.match(panel, /rail\.scrollBy\(/);
assert.match(panel, /featuredRailCanScroll/);
...
assert.match(panel, /if \(document\.hidden\) \{/);
assert.match(panel, /requestController\?\.abort\(\)/);
assert.match(panel, /refresh\(\);\s*startPolling\(\);/);
