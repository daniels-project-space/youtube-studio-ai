...
export const FIXED_EXECUTION_MODULES: readonly RegisteredModuleCard[] = [
  ...
  fixedModule("child_content_safety", "Children's safety review", "safety", "Requires child-safe language, curriculum evidence, and human review."),
  fixedModule("children_show_bible", "Children's show bible", "planning", "Seals the supervised learning channel identity and curriculum."),
  ...
  fixedModule("curriculum_episode_seed", "Curriculum episode seed", "planning", "Seeds a supervised learning episode from the approved curriculum."),
