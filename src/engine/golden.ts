...
export const GOLDEN_MODULES: GoldenModule[] = [
  ...
  },
  {
    key: "worked-example",
    stage: "brief",
    title: "Worked Example — Arithmetic Lesson Foundation",
    engine: "Typed integer derivation → exact speech draft → held decoded-clock visual handoff",
    how:
      "Provides a deterministic, request-bound arithmetic preparation and narration draft for the worked-example lesson lane. " +
      "The blocks are registered and catalog-owned for auditability, but remain private-review-only until the decoded narration clock, " +
      "native renderer handoff, natural-speech audition, and independent editorial qualification are complete. Catalog ownership must " +
      "never be mistaken for automatic channel admission or a paid provider route.",
    gates: [
      "request and namespace identity must match the active run",
      "integer derivation and speech draft remain deterministic and provider-free",
      "exact decoded narration clock must bind every visual beat before render admission",
      "natural-speech audition and independent editorial review remain required",
      "private human-review only while the renderer and route are held",
    ],
    status: "registered",
  },
  {
