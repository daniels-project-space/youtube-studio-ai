...
function transcriptProof(sourceSha256: string): NarrationTranscriptProof {
  return {
    ...
    expected: { textSha256: expectedTextSha256, wordCount: 11 },
    transcript: {
      text: "Mira finds a tiny seed. Mira gives it water and light.",
      wordCount: 11,
      words: [
        { text: "Mira", startMs: 0, endMs: 300 },
        { text: "finds", startMs: 300, endMs: 600 },
        { text: "a", startMs: 600, endMs: 700 },
        { text: "tiny", startMs: 700, endMs: 1_000 },
        { text: "seed", startMs: 1_000, endMs: 1_300 },
        { text: "Mira", startMs: 6_000, endMs: 6_300 },
        { text: "gives", startMs: 6_300, endMs: 6_600 },
        { text: "it", startMs: 6_600, endMs: 6_800 },
        { text: "water", startMs: 6_800, endMs: 7_100 },
        { text: "and", startMs: 7_100, endMs: 7_300 },
        { text: "light", startMs: 7_300, endMs: 7_600 },
      ],
    },
    assessment: {
      wordErrorRate: 0,
