...
const beforeBodySha256 = process.env.QWEN3_TTS_RUNTIME_PROFILE === "openrelay-3090-persistent"
  ? [
    "ceffa97d0dbb528380da7ea39d0e5b89aa7bae1dd1505d664dbafbd7a51a4a81",
    "ceffa97d0dbb528380da7ea39d0e5b89aa7bae1dd1505d664dbafbd7a51a4a81",
    "cdba0239ff77c2c2fd35fecdb263098d4addd1c12b7357e7fef317168240da45",
    "3e4547572a58c57df7125b5b1d35978fd3606b91a5c7cee2974f78d4ab84383a",
    "51fafc5975dcbfd996d57fcf3bbb1815de7e6ba062baa93828238f011b35188a",
    "9ca6be5530118d4dfe0d6700c4679ae33bb332fc3dae0a0f94985785db0aacf4",
  ]
  : [
...
globalThis.fetch = async (_url, init) => {
  ...
  const response = execFileSync("python3", [join(process.cwd(), "workers/qwen3-tts/contract.py"), "--fixture"], {
    input: JSON.stringify({ payload: request, idempotencyKey: request.requestKey, audioBase64: audio.toString("base64"), durationSec: 20, requestGpuSeconds: 10, gpuRateUsdPerSecond: 0.00005 }), encoding: "utf8", env: workerRuntimeEnv(),
  });
