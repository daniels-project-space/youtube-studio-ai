...
interface QwenTtsRuntimeReceiptBase {
...
// Keep the stored receipt discriminated. Independent provider/GPU unions
// would admit impossible pairs (for example OpenRelay + RTX 4090) and cannot
// satisfy Convex's exact durable validator.
export type QwenTtsRuntimeReceipt = QwenTtsRuntimeReceiptBase & (
  | {
    provider: "novita";
    gpu: "RTX 4090";
