...
python3 - <<'PY'
import hashlib, json, os, pathlib, shutil, sys, traceback, urllib.request
...
console.log(JSON.stringify({ event: "created", instanceId, receiptKey, maxUsd: RATE_USD_PER_HOUR * MAX_STAGE_SECONDS / 3600 }));
let receipt;
try {
