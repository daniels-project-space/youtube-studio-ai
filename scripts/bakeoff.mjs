...
const MODELS = [
  { name: "ltx-distilled", slug: "lightricks/ltx-video-0.9.7-distilled", build: () => ({ image: img, prompt: PROMPT, resolution: 720, aspect_ratio: "16:9", num_frames: 97, negative_prompt: NEG }) },
